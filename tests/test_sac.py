...
from mlx_baselines3.sac.policies import SACPolicy, MlpPolicy
...
class TestSAC:
    ...
    def test_sac_policy_forward(self):
        ...
        # Test forward pass
        actions, values, log_probs = model.policy.forward(obs_tensor, deterministic=False)
        ...
        actions_det, values_det, log_probs_det = model.policy.forward(obs_tensor, deterministic=True)
        
        # Deterministic actions should be different from stochastic (with high probability)
        # Values should be zeros for SAC
    ...
    def test_sac_actor_critic_forward(self):
        ...
        sampled_actions, log_probs, entropy = model.policy.actor_forward(features, deterministic=False)
    ...
    def test_sac_save_load_parameters(self):
        ...
        new_params = model._get_parameters()
    ...
    def test_sac_short_training(self):
        ...
        print(f"Initial timesteps: {initial_timesteps}, Final timesteps: {model.num_timesteps}")
