...
from mlx_baselines3.common.torch_layers import MlxModule, MlxLinear, MlxSequential, create_mlp
...
def test_actor_critic_policy_state_dict_roundtrip():
    ...
    assert mx.array_equal(action1, action2), "Predictions should be identical after loading state"
