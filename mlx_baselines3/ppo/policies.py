...
class CnnPolicy(PPOPolicy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from mlx_baselines3.common.torch_layers import NatureCNN
        
        super().__init__(
            *args,
            **kwargs,
            features_extractor_class=NatureCNN,
            normalize_images=False,  # NatureCNN handles normalization
        )
...
class MultiInputPolicy(PPOPolicy):
    ...
    def __init__(self, *args, **kwargs):
        # Import here to avoid circular imports  
        from mlx_baselines3.common.torch_layers import CombinedExtractor
