...
from mlx_baselines3.common.vec_env import VecEnv, VecEnvWrapper, DummyVecEnv, make_vec_env
...
class TestVecEnv:
    ...
    def test_vec_env_is_abstract(self):
        ...
        with pytest.raises(TypeError):
            VecEnv(1, gym.spaces.Box(low=-1, high=1, shape=(4,)), gym.spaces.Discrete(2))
