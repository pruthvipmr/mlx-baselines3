"""
MLX-native optimizer adapters for stable, functional gradient-based optimization.

This module provides optimizer adapters that work with MLX's functional autograd
system, maintaining optimizer state (like Adam moments) separately from model parameters.
"""

from typing import Dict, Any, Tuple, TypedDict, Union, Callable
...
def compute_loss_and_grads(
    loss_fn: Callable[[Dict[str, mx.array]], mx.array],
    params: Dict[str, mx.array]
