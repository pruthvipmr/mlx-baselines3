...
from mlx_baselines3.common.torch_layers import BaseFeaturesExtractor, FlattenExtractor, create_mlp
...
class CnnPolicy(DQNPolicy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # For now, fallback to MLP (will be enhanced when CNN extractor is implemented)
        super().__init__(*args, **kwargs, features_extractor_class=FlattenExtractor)
...
class MultiInputPolicy(DQNPolicy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # For now, fallback to MLP (will be enhanced when MultiInput extractor is implemented)
        super().__init__(*args, **kwargs, features_extractor_class=FlattenExtractor)
